...
import {ButtonLink} from '../home/styled-components';
import {Container} from '../../ui/container/container';
import {CartTitle, CartTitleEmpty} from './styled-components';
  ...
  return (
    <Container>
      <Column styles={{overflow: 'auto'}}>
        ...
        <Row styles={{marginTop: '2rem', alignItems: 'center'}}>
          <ButtonLink to="/order/new" style={{marginRight: '1rem'}}>
            Order Pizzas
          </ButtonLink>
